...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/pericentromeres/analysis_01/plots/"
...
pdf(paste0(plotDir, "REC8_HA_Rep1_peri_peakProfiles_winSize20.pdf"), height = 95, width = 6)
par(mfrow = c(38, 2))
