...
# Usage:
# Rscript TE_family_wt_REC8_HA_Rep1_vs_wt_REC8_MYC_Rep1_arm_peaks_TEST.R "REC8 arm peaks" "wt REC8-HA Rep1" "wt REC8-MYC Rep1" wt_REC8_HA_Rep1 wt_REC8_MYC_Rep1 10000

library(ggplot2)
library(ggthemes)

dataName <- "REC8 arm peaks" 
...
inDir1 <- "/home/meiosis/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/arms/regioneR/noMinWidth_mergedOverlaps/"
inDir2 <- "/home/meiosis/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_MYC_Rep1/arms/regioneR/noMinWidth_mergedOverlaps/"
...
load(paste0(inDir1, "permTest_REC8_HA_Rep1_armrangerPeaks_vs_TEsDNA.RData"))
pt1_DNA <- ptPeaksTEsDNAPerChrom
ptPeaksTEsDNAPerChrom <- NULL
load(paste0(inDir1, "permTest_REC8_HA_Rep1_armrangerPeaks_vs_TEsRNA.RData"))
pt1_RNA <- ptPeaksTEsRNAPerChrom
ptPeaksTEsRNAPerChrom <- NULL
pt1 <- c(pt1_DNA, pt1_RNA)

load(paste0(inDir2, "permTest_REC8_MYC_Rep1_armrangerPeaks_vs_TEsDNA.RData"))
pt2_DNA <- ptPeaksTEsDNAPerChrom
ptPeaksTEsDNAPerChrom <- NULL
load(paste0(inDir2, "permTest_REC8_MYC_Rep1_armrangerPeaks_vs_TEsRNA.RData"))
