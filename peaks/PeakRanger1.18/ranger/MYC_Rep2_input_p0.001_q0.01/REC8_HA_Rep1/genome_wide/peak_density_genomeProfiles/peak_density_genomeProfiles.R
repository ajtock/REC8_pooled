...
# Usage:
# Rscript peak_density_genomeProfiles.R /home/meiosis/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/genome_wide/REC8_HA_Rep1_wt_kss_diff/REC8_HA_Rep1_peaks_mean_log2_REC8_HA_Rep1_wt_kss_diff_cov_top10percentGR.RData 10000 10kb
...
print(peaksGR)
baseName <- basename(as.character(args[1]))
len <- nchar(baseName)
# WARNING: ASSUMES INPUT FILE HAS A 5-LETTER EXTENSION ("RData")
# AND NAME ENDS WITH "GR"
peakSet <- substr(baseName, 1, len-8)
