...
outDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/genome_wide/H3K9me2_wt_kss_diff/"
...
allCovPeaks <- read.table(paste0(outDir,
                                 "REC8_HA_Rep1_peaks_mean_log2_H3K9me2_wt_kss_diff_cov.txt"),
                          header = T)
...
write.table(allCovPeaks_top10percent,
            paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_H3K9me2_wt_kss_diff_cov_top10percent.txt"),
            sep = "\t", quote = F)
...
allCovPeaks_top10percentGR <- GRanges(seqnames = allCovPeaks_top10percent$Chr,
                                      ...
                                      strand = "*",
                                      diff_wt_kss_norm_peakCov = allCovPeaks_top10percent$diff_wt_kss_norm_peakCov, 
                                      diff_wt_kss_norm_peakRank = allCovPeaks_top10percent$diff_wt_kss_norm_peakRank)
save(allCovPeaks_top10percentGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_H3K9me2_wt_kss_diff_cov_top10percentGR.RData"))
...
allCovPeaks_top10percent_armGR <- GRanges(seqnames = allCovPeaks_top10percent_arm$Chr,
                                          ...
                                          strand = "*",
                                          diff_wt_kss_norm_peakCov = allCovPeaks_top10percent_arm$diff_wt_kss_norm_peakCov,
                                          diff_wt_kss_norm_peakRank = allCovPeaks_top10percent_arm$diff_wt_kss_norm_peakRank)
save(allCovPeaks_top10percent_armGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_H3K9me2_wt_kss_diff_cov_top10percent_armGR.RData"))
...
allCovPeaks_top10percent_periGR <- GRanges(seqnames = allCovPeaks_top10percent_peri$Chr,
                                          ...
                                          strand = "*",
                                          diff_wt_kss_norm_peakCov = allCovPeaks_top10percent_peri$diff_wt_kss_norm_peakCov,
                                          diff_wt_kss_norm_peakRank = allCovPeaks_top10percent_peri$diff_wt_kss_norm_peakRank)
save(allCovPeaks_top10percent_periGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_H3K9me2_wt_kss_diff_cov_top10percent_periGR.RData"))
