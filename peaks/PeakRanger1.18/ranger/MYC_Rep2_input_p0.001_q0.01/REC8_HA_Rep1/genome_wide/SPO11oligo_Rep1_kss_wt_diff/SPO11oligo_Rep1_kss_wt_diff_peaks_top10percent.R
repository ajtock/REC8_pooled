...
write.table(allCovPeaks_top10percent,
            paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_SPO11oligo_Rep1_kss_wt_diff_cov_top10percent.txt"),
            sep = "\t", quote = F)
...
save(allCovPeaks_top10percentGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_SPO11oligo_Rep1_kss_wt_diff_cov_top10percentGR.RData"))
...
save(allCovPeaks_top10percent_armGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_SPO11oligo_Rep1_kss_wt_diff_cov_top10percent_armGR.RData"))
...
save(allCovPeaks_top10percent_periGR,
     file = paste0(outDir,
                   "REC8_HA_Rep1_peaks_mean_log2_SPO11oligo_Rep1_kss_wt_diff_cov_top10percent_periGR.RData"))
