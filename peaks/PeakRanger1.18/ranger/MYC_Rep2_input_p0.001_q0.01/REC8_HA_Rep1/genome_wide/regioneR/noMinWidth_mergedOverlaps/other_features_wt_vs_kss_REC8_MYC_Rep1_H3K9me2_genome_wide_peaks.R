...
# Usage:
# Rscript other_features_wt_vs_kss_REC8_MYC_Rep1_H3K9me2_genome_wide_peaks.R "REC8 peaks and H3K9me2 peaks" "wt REC8-MYC Rep1" "kss REC8-HA Rep1" "wt H3K9me2" "kss H3K9me2" wt_REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_H3K9me2 kss_H3K9me2 10000 

library(ggplot2)
library(ggthemes)

dataName <- "REC8 peaks and H3K9me2 peaks"
pt1REC8Name <- "wt REC8-MYC Rep1"
pt2REC8Name <- "kss REC8-HA Rep1"
pt1Name <- "wt H3K9me2" 
pt2Name <-  "kss H3K9me2" 
pt1REC8LibName <- "wt_REC8_MYC_Rep1"
...
REC8Dir1 <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_MYC_Rep1/genome_wide/regioneR/noMinWidth_mergedOverlaps/"
...
otherNamesPlot <- c("REC8-HA Rep1 peaks", "REC8-HA Rep2 peaks", "kss REC8-HA Rep1 peaks",
                    "Nucleosomes", "Nucleosomes (ranger)",
                    "SPO11-1-oligo hotspots", "SPO11-1 ChIP peaks", "SPO11-1 ChIP13 peaks",
                    "H3K4me3 peaks", "H3K9me2 peaks/REC8 peaks", "H3K9me2 peaks (bcp)", "Crossovers",
...
load(paste0(REC8Dir1, "permTest_REC8_MYC_Rep1_rangerPeaks_vs_others.RData"))
...
load(paste0(inDir1, "permTest_H3K9me2_rangerPeaks_vs_others.RData"))
pt1 <- ptPeaksOtherPerChrom
ptPeaksOtherPerChrom <- NULL
pt1 <- pt1[c(-1:-3, -5, -8, -11)]

load(paste0(inDir2, "permTest_kss_H3K9me2_rangerPeaks_vs_others.RData"))
