...
# Usage:
# Rscript TE_family_wt_vs_kss_REC8_HA_Rep1_SPO11oligo_H3K9me2_genome_wide_peaks.R "REC8 peaks, SPO11-1-oligo hotspots and H3K9me2 peaks" "wt REC8-HA Rep1" "kss REC8-HA Rep1" "wt SPO11-1-oligos" "kss SPO11-1-oligos" "wt H3K9me2" "kss H3K9me2" wt_REC8_HA_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo wt_H3K9me2 kss_H3K9me2 10000
...
pt1_REC8_log2ObsExp_sorted <- sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T)
pt1_REC8_log2alpha0.05_sorted <- unlist(pt1_REC8_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt1_REC8_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt1_REC8_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
...
pt2_REC8_log2ObsExp_sorted <- unlist(pt2_REC8_log2ObsExp[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt2_REC8_log2alpha0.05_sorted <- unlist(pt2_REC8_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt2_REC8_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt2_REC8_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
...
pt1_log2ObsExp_sorted <- unlist(pt1_log2ObsExp[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt1_log2alpha0.05_sorted <- unlist(pt1_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt1_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt1_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
...
pt2_log2ObsExp_sorted <- unlist(pt2_log2ObsExp[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt2_log2alpha0.05_sorted <- unlist(pt2_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt2_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt2_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
...
pt3_log2ObsExp_sorted <- unlist(pt3_log2ObsExp[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt3_log2alpha0.05_sorted <- unlist(pt3_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt3_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt3_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
...
pt4_log2ObsExp_sorted <- unlist(pt4_log2ObsExp[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt4_log2alpha0.05_sorted <- unlist(pt4_log2alpha0.05[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix])
pt4_famNames_sorted <- famNames[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
pt4_famNamesPlot_sorted <- famNamesPlot[sort.int(unlist(pt1_REC8_log2ObsExp), decreasing = T, index.return = T)$ix]
