...
# Usage:
# Rscript TE_family_wt_vs_kss_REC8_MYC_Rep1_SPO11oligo_H3K9me2_genome_wide_peaks.R "REC8 peaks, SPO11-1-oligo hotspots and H3K9me2 peaks" "wt REC8-MYC Rep1" "kss REC8-HA Rep1" "wt SPO11-1-oligos" "kss SPO11-1-oligos" "wt H3K9me2" "kss H3K9me2" wt_REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo wt_H3K9me2 kss_H3K9me2 10000
...
load(paste0(REC8Dir1, "permTest_REC8_MYC_Rep1_rangerPeaks_vs_TEsDNA.RData"))
pt1_REC8_DNA <- ptPeaksTEsDNAPerChrom
ptPeaksTEsDNAPerChrom <- NULL
load(paste0(REC8Dir1, "permTest_REC8_MYC_Rep1_rangerPeaks_vs_TEsRNA.RData"))
