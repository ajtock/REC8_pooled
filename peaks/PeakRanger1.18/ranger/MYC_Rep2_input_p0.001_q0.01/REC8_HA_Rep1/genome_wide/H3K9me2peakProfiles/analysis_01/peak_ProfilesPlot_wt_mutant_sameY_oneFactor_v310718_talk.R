...
pdf(paste0(plotDir, "H3K9me2_peaks_genome_wide_peakProfiles_wt_mutant_H3K9me2_REC8_SPO11_1_oligos_RNAseq_DNAmeth_MNase_PolIV_PolV_winSize20_v310718_talk.pdf"), height = 10, width = 7.5)
par(mfcol = c(4, 3))
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat[[20]][,1],
    mutantDat1  = target_covDat[[21]][,1],
    ranDat1 = ranLoc_covDat[[20]][,1],
    mutantRanDat1 = ranLoc_covDat[[21]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat[[23]][,1],
    mutantDat1  = target_covDat[[24]][,1],
    ranDat1 = ranLoc_covDat[[23]][,1],
    mutantRanDat1 = ranLoc_covDat[[24]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat[[10]][,1],
    mutantDat1  = target_covDat[[12]][,1],
    ranDat1 = ranLoc_covDat[[10]][,1],
