...
matDir <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/genome_wide/H3K9me2peakProfiles/analysis_01/matrices/"
plotDir <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_HA_Rep1/genome_wide/H3K9me2peakProfiles/analysis_01/plots/"
...
pdf(paste0(plotDir, "H3K9me2_peaks_genome_wide_peakProfiles_wt_mutant_H3K9me2_REC8_SPO11_1_oligos_RNAseq_DNAmeth_MNase_PolIV_PolV_winSize20.pdf"), height = 40, width = 6)
par(mfrow = c(16, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
xplot <- seq(1, length(target_covDat[[14]][,1]), by = 1)
mycolsOneWTmutant <- c("green", "forestgreen")
mycolsAnotherWTmutant <- c("blue", "navy")

plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    dat2 = target_covDat[[1]][,1],
    mutantDat1  = target_covDat[[15]][,1],
    mutantDat2 = target_covDat[[4]][,1],
    ranDat1 = ranLoc_covDat[[14]][,1],
    ranDat2 = ranLoc_covDat[[1]][,1],
    mutantRanDat1 = ranLoc_covDat[[15]][,1],
    mutantRanDat2 = ranLoc_covDat[[4]][,1],
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[1],
    flankSize = 2000, winSize = 20, 
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[1], libNames[4]),
...
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[16], libNames[1], libNames[4]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
...
plotAvgCov_oneWTmutantVanotherWT(xplot = xplot,
    ...
    mutantRanDat1 = ranLoc_covDat[[15]][,1],
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[8],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[26]),
    mycolsDat1 = mycolsOneWTmutant,
...
plotAvgCov_oneWTmutantVanotherWT(xplot = xplot,
    ...
    mutantRanDat1 = ranLoc_covDat[[15]][,1],
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[9],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[27]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant[1])
plotAvgCov_oneWTmutantVanotherWT(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    mutantRanDat1 = ranLoc_covDat[[15]][,1],
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[10],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[28]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant[1])
...
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    ...
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[2],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[5], libNames[8]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[6], libNames[8]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[7], libNames[9]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[3],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[10], libNames[12]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[11], libNames[13]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
...
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    ...
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[5],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[17], libNames[18]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[17], libNames[19]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
...
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    ...
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[6],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[20], libNames[21]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[20], libNames[22]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
...
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    ...
    Ylabel1 = YlabelNames[4], Ylabel2 = YlabelNames[7],
    flankSize = 2000, winSize = 20,
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "Start", endLab1 = "End",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[23], libNames[24]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
plotAvgCov_oneWTmutantVanotherWTmutant(xplot = xplot,
    dat1 = target_covDat[[14]][,1],
    ...
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[14], libNames[15], libNames[23], libNames[25]),
    mycolsDat1 = mycolsOneWTmutant,
    mycolsDat2 = mycolsAnotherWTmutant)
