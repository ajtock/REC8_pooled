...
plotDir <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/DiffBind/analysis_01_DB_sites_kss_exceeds_wt/plots/"
...
pdf(paste0(plotDir, "DB_REC8_HA_peaks_kss_exceeds_wt_genome_wide_peakProfiles_wt_mutant_REC8_SPO11_1_oligos_CHGmeth_H3K9me2_SPO11_1_ChIP_MNase_PolIV_PolV_winSize20_manuscript.pdf"), height = 12.5, width = 6)
par(mfrow = c(5, 2))
