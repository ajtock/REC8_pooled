...
# Usage:
# Rscript TE_family_wt_REC8_MYC_Rep1_vs_kss_REC8_HA_Rep1_genome_wide_peaks.R "REC8 peaks" "wt REC8-MYC Rep1" "kss REC8-HA Rep1" wt_REC8_MYC_Rep1 kss_REC8_HA_Rep1 10000

library(ggplot2)
library(ggthemes)

dataName <- "REC8 peaks" 
pt1Name <- "wt REC8-MYC Rep1" 
pt2Name <-  "kss REC8-HA Rep1" 
pt1LibName <- "wt_REC8_MYC_Rep1"
...
inDir1 <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep2_input_p0.001_q0.01/REC8_MYC_Rep1/genome_wide/regioneR/noMinWidth_mergedOverlaps/"
...
load(paste0(inDir1, "permTest_REC8_MYC_Rep1_rangerPeaks_vs_TEsDNA.RData"))
pt1_DNA <- ptPeaksTEsDNAPerChrom
ptPeaksTEsDNAPerChrom <- NULL
load(paste0(inDir1, "permTest_REC8_MYC_Rep1_rangerPeaks_vs_TEsRNA.RData"))
