...
# Usage:
# csmit -m 24G -c 24 "./REC8_peaks_peakranger_ranger_kss_REC8_HA_Rep1_ChIP.sh 0.001 0.01" 
...
ChIPbamDir=/home/meiosis/ajt200/analysis/180622_Chris_lambing_ChIP_REC8_HA_Col_kss/kss
inputbamDir=/home/meiosis/ajt200/analysis/REC8_pooled
...
do
  peakranger ranger -d $ChIPbamDir/${i}_ChIP_RmDup_k10_bt2_mapped_lowmiss_unique_both_sort.bam \
                    -c $inputbamDir/REC8_MYC_Rep2_input_RmDup_k10_bt2_mapped_lowmiss_unique_both_sort.bam \
