...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_arm_peaks_vs_TEfams.R REC8_MYC_Rep1_ChIP_rangerPeaksGR_arm_mergedOverlaps_noMinWidth.RData REC8_MYC_Rep1_arm_peaks 10000"
