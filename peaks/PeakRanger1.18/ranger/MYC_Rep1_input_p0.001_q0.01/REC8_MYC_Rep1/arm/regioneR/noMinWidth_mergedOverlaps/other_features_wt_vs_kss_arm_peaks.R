...
# Usage:
# ./other_features_wt_vs_kss_arm_peaks.R "REC8 arm peaks" "wt REC8-MYC Rep1" "kss REC8-HA Rep1" REC8_MYC_Rep1 kss_REC8_HA_Rep1 REC8_MYC_Rep1 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "REC8 arm peaks"
#wt_pt1Name <- "wt REC8-MYC Rep1"
...
otherNamesPlot <- c("wt REC8-HA Rep2",
                    "Nucleosomes",
