...
# Usage:
# ./other_features_wt_only_REC8_SPO11oligos_nucleosomes_arm_peaks.R "Arm REC8-Myc peaks, nucleosomes and SPO11-1-oligo hotspots" "REC8-Myc" "SPO11-1" "Nucleosomes" REC8_MYC_Rep1 wt_SPO11oligo nucleosomes REC8_HA_Rep2 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Arm REC8-Myc peaks, nucleosomes and SPO11-1-oligo hotspots"
#pt1Name <- "REC8-Myc"
#pt2Name <- "SPO11-1"
#pt3Name <- "Nucleosomes"
