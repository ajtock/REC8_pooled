...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_genomewide_peaks_vs_TEfams.R REC8_MYC_Rep1_ChIP_rangerPeaksGR REC8_MYC_Rep1_genomewide_peaks 10000"

#peakPrefix1 <- "REC8_MYC_Rep1_ChIP_rangerPeaksGR"
#peakName1 <- "REC8_MYC_Rep1_genomewide_peaks"
#perms <- 10000
...
load(paste0(inDir,
            peakPrefix1,
            "_arm_mergedOverlaps_noMinWidth.RData"))
load(paste0(inDir,
            peakPrefix1,
            "_peri_mergedOverlaps_noMinWidth.RData"))
peaksGR <- sort(c(rangerPeaksGR_arm_mergedOverlaps,
                  rangerPeaksGR_peri_mergedOverlaps))
