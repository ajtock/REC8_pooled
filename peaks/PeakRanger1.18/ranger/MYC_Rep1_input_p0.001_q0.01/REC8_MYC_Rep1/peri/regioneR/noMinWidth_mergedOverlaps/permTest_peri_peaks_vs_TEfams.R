...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_peri_peaks_vs_TEfams.R REC8_MYC_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData REC8_MYC_Rep1_peri_peaks 10000"
