...
# Usage:
# ./other_selected_features_TE_selected_families_wt_vs_kss_REC8_SPO11oligos_peri_peaks.R "Pericentromeric REC8-Myc peaks and SPO11-1-oligo hotspots" "wt REC8-Myc" "kss REC8-HA" "wt SPO11-1" "kss SPO11-1" REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 peri 10000
...
# Note that last subdirectory (noMinWidth_mergedOverlaps_vs_REC8_HA_Rep2)
...
ptOrder <- c(ptOrder[otherNumbers],
