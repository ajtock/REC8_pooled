...
# Usage:
# ./other_features_REC8_vs_control_peri_peaks.R "REC8-Myc Rep1 and Control-Myc Rep1 peri peaks" "REC8-Myc Rep1" "Control-Myc Rep1" REC8_MYC_Rep1 control_MYC_Rep1 REC8_MYC_Rep1 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "REC8-Myc Rep1 and control-Myc Rep1 peri peaks"
...
load(paste0(wt_ptOrderDir, "permTest_", perms, "perms_",
            wt_ptOrderLibName, "_peri_peaks_vs_others.RData"))
...
load(paste0(wt_pt1Dir, "permTest_", perms, "perms_",
            wt_pt1LibName, "_peri_peaks_vs_others.RData"))
wt_pt1 <- ptPeaksOtherPerChrom
ptPeaksOtherPerChrom <- NULL

load(paste0(wt_pt2Dir, "permTest_", perms, "perms_",
            wt_pt2LibName, "_peri_peaks_vs_others.RData"))
