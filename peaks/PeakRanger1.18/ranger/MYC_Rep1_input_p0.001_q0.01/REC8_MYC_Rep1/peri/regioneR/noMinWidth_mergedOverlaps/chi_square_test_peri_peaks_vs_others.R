...
# Usage: 
# /applications/R/R-3.5.0/bin/Rscript chi_square_test_peri_peaks_vs_others.R REC8_MYC_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData kss_REC8_HA_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData "wt REC8-Myc" "kss REC8-HA" "wt SPO11-1" "kss SPO11-1" REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo "Pericentromeric REC8-Myc peaks and SPO11-1-oligo hotspots" peri
...
#plotTitle <- "Pericentromeric REC8-Myc peaks and SPO11-1-oligo hotspots"
#region <- "peri"
