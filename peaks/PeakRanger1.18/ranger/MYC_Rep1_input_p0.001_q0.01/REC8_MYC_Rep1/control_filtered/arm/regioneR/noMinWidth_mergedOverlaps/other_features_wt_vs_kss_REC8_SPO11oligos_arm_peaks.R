...
# Usage:
# ./other_features_wt_vs_kss_REC8_SPO11oligos_arm_peaks.R "Control-filtered arm REC8-Myc peaks and SPO11-1-oligo hotspots" "wt REC8-Myc" "kss REC8-HA" "wt SPO11-1-oligos" "kss SPO11-1-oligos" REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Control-filtered arm REC8-Myc peaks and SPO11-1-oligo hotspots"
#pt1Name <- "wt REC8-Myc"
#pt2Name <- "kss REC8-HA"
