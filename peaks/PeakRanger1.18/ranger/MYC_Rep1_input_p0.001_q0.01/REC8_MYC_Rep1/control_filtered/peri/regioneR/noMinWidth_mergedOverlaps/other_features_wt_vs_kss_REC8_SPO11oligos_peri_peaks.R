...
# Usage:
# ./other_features_wt_vs_kss_REC8_SPO11oligos_peri_peaks.R "Control-filtered pericentromeric REC8-Myc peaks and SPO11-1-oligo hotspots" "wt REC8-Myc" "kss REC8-HA" "wt SPO11-1-oligos" "kss SPO11-1-oligos" REC8_MYC_Rep1 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Control-filtered pericentromeric REC8-Myc peaks and SPO11-1-oligo hotspots"
#pt1Name <- "wt REC8-Myc"
#pt2Name <- "kss REC8-HA"
...
pt3Dir <- paste0("/projects/ajt200/BAM_masters/SPO11-oligo/WT/peaks/PeakRanger1.18/ranger/p0.2_q0.2/idr/qValRank/minuslog10_pval_qval/RPI1_RPI8_profiles_rangerPeaks_idr0.05/",
                 region, "/regioneR/noMinWidth_mergedOverlaps_vs_control_filtered_REC8/")
...
otherNamesPlot <- c("REC8-HA",
                    "Nucleosomes",
                    "SPO11-1-oligo hotspots/REC8-Myc",
                    "SPO11-1 ChIP Rep1",
                    "SPO11-1 ChIP Rep2",
                    "H3K4me3 Rep2",
                    "H3K4me3 Rep3",
                    ...
                    "Gene introns",
                    "Transposons",
                    "Hypo-CHG DMRs in kss",
                    "Hypo-CHH DMRs in kss")
