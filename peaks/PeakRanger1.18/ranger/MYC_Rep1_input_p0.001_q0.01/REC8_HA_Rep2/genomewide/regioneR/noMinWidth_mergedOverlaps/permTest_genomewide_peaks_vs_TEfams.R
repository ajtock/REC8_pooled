...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_genomewide_peaks_vs_TEfams.R REC8_HA_Rep2_ChIP_rangerPeaksGR REC8_HA_Rep2_genomewide_peaks 10000"

#peakPrefix1 <- "REC8_HA_Rep2_ChIP_rangerPeaksGR"
#peakName1 <- "REC8_HA_Rep2_genomewide_peaks"
#perms <- 10000
