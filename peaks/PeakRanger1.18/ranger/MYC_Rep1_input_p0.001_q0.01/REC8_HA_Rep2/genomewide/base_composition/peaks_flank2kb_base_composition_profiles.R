...
outDir <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/REC8_HA_Rep2/genomewide/base_composition/"
plotDir <- "/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/REC8_HA_Rep2/genomewide/base_composition/plots/"
...
load(paste0("/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/",
            "REC8_HA_Rep2_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData"))
targetsGR <- sortSeqlevels(c(rangerPeaksGR_arm_mergedOverlaps, rangerPeaksGR_peri_mergedOverlaps))
strand(targetsGR) <- "*"
targetsGR <- sort(targetsGR)
print("***********peaks***********")
print(targetsGR)
...
pdf(paste0(plotDir, "REC8_HA_Rep2_genome_wide_peak_base_relative_frequency_diffYaxes_v250619.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
...
mergeBaseFreqPlotDiffY(at.coords = target.ATfreq, gc.coords = target.GCfreq,
                       ...
                       mainTitle1 = bquote("REC8-HA peaks ("*italic("n")*" = "*.(prettyNum(length(targetsGR),
                                                                                           big.mark = ",", trim = T))*")"),
...
pdf(paste0(plotDir, "REC8_HA_Rep2_genome_wide_peak_base_relative_frequency_v250619.pdf"), height = 5, width = 6)
par(mfrow = c(2, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 2000
...
pdf(paste0(plotDir, "REC8_HA_Rep2_genome_wide_peak_base_relative_frequency_AT_and_GC_diffYlims_v250619.pdf"), height = 10, width = 6)
par(mfrow = c(4, 2))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
flankSize <- 2000
