...
# Usage:
# ./TE_family_REC8_vs_control_arm_peaks.R "REC8-HA Rep2 and Control-HA Rep1 arm peaks" "REC8-HA Rep2" "Control-HA Rep1" REC8_HA_Rep2 control_HA_Rep1 REC8_MYC_Rep1 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "REC8-HA Rep2 and Control-HA Rep1 arm peaks"
...
load(paste0(wt_ptOrderDir, "permTest_", perms, "perms_",
            wt_ptOrderLibName, "_arm_peaks_vs_TEsDNA.RData"))
wt_ptOrder_DNA <- ptPeaksTEsDNAPerChrom
ptPeaksTEsDNAPerChrom <- NULL
load(paste0(wt_ptOrderDir, "permTest_", perms, "perms_",
            wt_ptOrderLibName, "_arm_peaks_vs_TEsRNA.RData"))
