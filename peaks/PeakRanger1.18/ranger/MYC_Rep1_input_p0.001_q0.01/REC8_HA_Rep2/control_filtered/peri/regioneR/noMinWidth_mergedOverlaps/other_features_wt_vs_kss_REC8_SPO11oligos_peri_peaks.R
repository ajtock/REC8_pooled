...
# Usage:
# ./other_features_wt_vs_kss_REC8_SPO11oligos_peri_peaks.R "Control-filtered pericentromeric REC8-HA peaks and SPO11-1-oligo hotspots" "wt REC8-HA" "kss REC8-HA" "wt SPO11-1-oligos" "kss SPO11-1-oligos" REC8_HA_Rep2 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Control-filtered pericentromeric REC8-HA peaks and SPO11-1-oligo hotspots"
#pt1Name <- "wt REC8-HA"
#pt2Name <- "kss REC8-HA"
...
otherNamesPlot <- c("REC8-Myc",
                    "Nucleosomes",
                    "SPO11-1-oligo hotspots/REC8-HA",
                    "SPO11-1 ChIP Rep1",
                    "SPO11-1 ChIP Rep2",
                    "H3K4me3 Rep2",
                    "H3K4me3 Rep3",
