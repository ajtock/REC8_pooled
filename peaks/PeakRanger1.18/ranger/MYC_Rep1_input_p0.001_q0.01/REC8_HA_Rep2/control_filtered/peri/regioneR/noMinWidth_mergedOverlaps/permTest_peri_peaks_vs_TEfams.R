...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_peri_peaks_vs_TEfams.R REC8_HA_Rep2/control_filtered/REC8_HA_Rep2_ChIP_rangerPeaksGR_peri_control_filtered_mergedOverlaps_noMinWidth.RData REC8_HA_Rep2_peri_peaks 10000"
