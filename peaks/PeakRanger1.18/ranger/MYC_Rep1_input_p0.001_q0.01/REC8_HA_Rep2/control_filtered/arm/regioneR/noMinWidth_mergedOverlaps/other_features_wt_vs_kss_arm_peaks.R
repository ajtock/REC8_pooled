...
# Usage:
# ./other_features_wt_vs_kss_arm_peaks.R "REC8 arm peaks" "wt REC8-HA Rep2" "kss REC8-HA Rep1" REC8_HA_Rep2 kss_REC8_HA_Rep1 REC8_MYC_Rep1 arm 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "REC8-HA arm peaks"
#wt_pt1Name <- "wt REC8-HA Rep2"
#wt_pt2Name <- "kss REC8-HA Rep1"
#wt_pt1LibName <- "REC8_HA_Rep2" 
#wt_pt2LibName <- "kss_REC8_HA_Rep1"
...
wt_ptOrderDir <- paste0("/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/",
                        wt_ptOrderLibName, "/control_filtered/",
...
wt_pt1Dir <- paste0("/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/",
                    wt_pt1LibName, "/control_filtered/",
                    region, "/regioneR/noMinWidth_mergedOverlaps/")
wt_pt2Dir <- paste0("/home/ajt200/analysis/180622_Chris_lambing_ChIP_REC8_HA_Col_kss/kss/peaks/PeakRanger1.18/ranger/rep_specific_input_p0.001_q0.01/",
                    wt_pt2LibName, "/control_filtered/",
...
otherNamesPlot <- c("wt REC8-Myc Rep1",
                    "Nucleosomes",
