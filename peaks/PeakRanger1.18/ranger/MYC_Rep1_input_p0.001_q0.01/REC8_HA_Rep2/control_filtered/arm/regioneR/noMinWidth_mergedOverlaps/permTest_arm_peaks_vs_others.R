...
# csmit -m 100G -c 32 "/applications/R/R-3.3.2/bin/Rscript permTest_arm_peaks_vs_others.R REC8_HA_Rep2/control_filtered/REC8_HA_Rep2_ChIP_rangerPeaksGR_arm_control_filtered_mergedOverlaps_noMinWidth.RData REC8_HA_Rep2_arm_peaks REC8_MYC_Rep1/control_filtered/REC8_MYC_Rep1_ChIP_rangerPeaksGR_arm_control_filtered_mergedOverlaps_noMinWidth.RData REC8_MYC_Rep1_arm_peaks 10000"

#peakFile1 <- "REC8_HA_Rep2/control_filtered/REC8_HA_Rep2_ChIP_rangerPeaksGR_arm_control_filtered_mergedOverlaps_noMinWidth.RData"
#peakName1 <- "REC8_HA_Rep2_arm_peaks"
#peakFile2 <- "REC8_MYC_Rep1/control_filtered/REC8_MYC_Rep1_ChIP_rangerPeaksGR_arm_control_filtered_mergedOverlaps_noMinWidth.RData"
...
load(paste0(inDir,
            peakFile2))
REC8_MYC_Rep1GR <- rangerPeaksGR_arm_control_filtered_mergedOverlaps
rangerPeaksGR_arm_control_filtered_mergedOverlaps <- NULL
