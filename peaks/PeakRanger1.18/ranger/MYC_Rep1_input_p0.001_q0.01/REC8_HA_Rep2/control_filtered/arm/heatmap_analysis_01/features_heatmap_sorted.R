...
# Usage:
# /applications/R/R-3.4.0/bin/Rscript features_heatmap_sorted.R REC8_HA_Rep2 REC8_HA_Rep2_arm_peaks 2000 2kb '2 kb' 20 20bp bodies

#libName <- "REC8_HA_Rep2"
#featureName <- "REC8_HA_Rep2_arm_peaks"
#upstream <- 2000
#downstream <- 2000
#flankName <- "2kb"
#flankNamePlot <- "2 kb"
