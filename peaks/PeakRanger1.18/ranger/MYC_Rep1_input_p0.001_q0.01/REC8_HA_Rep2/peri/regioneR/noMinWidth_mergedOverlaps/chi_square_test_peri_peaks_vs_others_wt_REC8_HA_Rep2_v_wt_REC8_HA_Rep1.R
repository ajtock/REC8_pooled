...
# Usage: 
# /applications/R/R-3.5.0/bin/Rscript chi_square_test_peri_peaks_vs_others_wt_REC8_HA_Rep2_v_wt_REC8_HA_Rep1.R REC8_HA_Rep2_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData REC8_HA_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData "wt REC8-HA_Rep2" "wt REC8-HA_Rep1" "wt SPO11-1" "kss SPO11-1" REC8_HA_Rep2 REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo "Pericentromeric REC8-HA peaks and SPO11-1-oligo hotspots" peri

#peakFile1 <- "REC8_HA_Rep2_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData"
#peakFile2 <- "REC8_HA_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData"
#peakName1 <- "wt REC8-HA Rep2"
#peakName2 <- "wt REC8-HA Rep1"
#peakName3 <- "wt SPO11-1"
#peakName4 <- "kss SPO11-1"
#peakLibName1 <- "REC8_HA_Rep2"
#peakLibName2 <- "REC8_HA_Rep1"
...
bp <- ggplot(data = df,
  ...
  scale_fill_manual(name = "",
                    values = c("red",
                               ...
                               "navy"),
                    labels = c(peakName1,
                               bquote(.(unlist(strsplit(peakName2,
                                                        split = " "))[1]) ~
