...
# Usage:
# ./other_selected_features_TE_selected_families_wt_vs_kss_REC8_SPO11oligos_peri_peaks_wt_REC8_HA_Rep2_v_wt_REC8_MYC_Rep1.R "Pericentromeric REC8 peaks and SPO11-1-oligo hotspots" "wt REC8-HA_Rep2" "wt REC8-Myc_Rep1" "wt SPO11-1" "kss SPO11-1" REC8_HA_Rep2 REC8_MYC_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 peri 10000
...
#pt2Name <- "wt REC8-Myc_Rep1"
#pt3Name <- "wt SPO11-1"
#pt4Name <- "kss SPO11-1"
#pt1LibName <- "REC8_HA_Rep2" 
#pt2LibName <- "REC8_MYC_Rep1"
...
pt2Dir <- paste0("/home/ajt200/analysis/REC8_pooled/peaks/PeakRanger1.18/ranger/MYC_Rep1_input_p0.001_q0.01/",
                 pt2LibName, "/",
                 region, "/regioneR/noMinWidth_mergedOverlaps/")
...
bp <- ggplot(data = df,
  ...
  scale_fill_manual(name = "",
                    values = c("red",
                               ...
                               "navy"),
                    labels = c(pt1Name,
                               bquote(.(unlist(strsplit(pt2Name,
                                                        split = " "))[1]) ~
