...
# Usage: 
# /applications/R/R-3.5.0/bin/Rscript chi_square_test_peri_peaks_vs_others.R REC8_HA_Rep2_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData kss_REC8_HA_Rep1_ChIP_rangerPeaksGR_peri_mergedOverlaps_noMinWidth.RData "wt REC8-HA" "kss REC8-HA" "wt SPO11-1" "kss SPO11-1" REC8_HA_Rep2 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo "Pericentromeric REC8-HA peaks and SPO11-1-oligo hotspots" peri
