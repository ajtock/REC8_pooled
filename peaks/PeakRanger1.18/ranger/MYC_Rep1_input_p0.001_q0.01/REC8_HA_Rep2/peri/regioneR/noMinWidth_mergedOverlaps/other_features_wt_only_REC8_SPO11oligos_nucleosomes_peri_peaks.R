...
# Usage:
# ./other_features_wt_only_REC8_SPO11oligos_nucleosomes_peri_peaks.R "Pericentromeric REC8-HA peaks, nucleosomes and SPO11-1-oligo hotspots" "REC8-HA" "SPO11-1" "Nucleosomes" REC8_HA_Rep2 wt_SPO11oligo nucleosomes REC8_HA_Rep2 peri 10000

library(ggplot2)
library(ggthemes)

#plotTitle <- "Pericentromeric REC8-HA peaks, nucleosomes and SPO11-1-oligo hotspots"
#pt1Name <- "REC8-HA"
#pt2Name <- "SPO11-1"
#pt3Name <- "Nucleosomes"
