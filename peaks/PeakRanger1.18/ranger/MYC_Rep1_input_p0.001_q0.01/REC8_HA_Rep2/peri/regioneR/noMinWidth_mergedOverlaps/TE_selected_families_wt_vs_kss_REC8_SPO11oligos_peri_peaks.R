...
# Usage:
# ./TE_selected_families_wt_vs_kss_REC8_SPO11oligos_peri_peaks.R "Pericentromeric REC8-HA peaks and SPO11-1-oligo hotspots" "wt REC8-HA" "kss REC8-HA" "wt SPO11-1" "kss SPO11-1" REC8_HA_Rep2 kss_REC8_HA_Rep1 wt_SPO11oligo kss_SPO11oligo REC8_HA_Rep2 peri 10000
...
# Combined
# Include only selected TE families
...
pt4 <- c(pt4_DNA, pt4_RNA)[famNumbers]
