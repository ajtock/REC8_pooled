...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/geneProfiles/exons/analysis_01/plots/"
...
pdf(paste0(plotDir, "REC8_HA_Rep1_exonProfiles_winSize20.pdf"), height = 95, width = 6)
par(mfrow = c(38, 2))
...
for(x in 2:length(libNames)) {
  plotAvgCov_oneVanother(xplot = xplot, dat1 = target_covDat[[1]][,1], dat2 = target_covDat[[x]][,1],
                         ...
                         flankSize = 1000, winSize = 20,
                         Ylabel1 = libNames[1], Ylabel2 = libNames[x],
                         flankLabL = "-1 kb", flankLabR = "+1 kb",
