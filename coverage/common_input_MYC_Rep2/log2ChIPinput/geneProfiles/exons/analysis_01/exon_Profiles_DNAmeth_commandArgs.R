...
# Profile mean DNA methylation around gene exons and random loci

# Usage via Condor submission system on node7:
# csmit -m 20G -c 1 "Rscript exon_Profiles_DNAmeth_commandArgs.R /home/meiosis/ajt200/BS_Seq/Stroud_2013/WT_rep2/wig/bed/GSM980986_WT_rep2_CG.wig.bed.gr.tab.bed CGmeth"
...
DNAmethMatrix(signal = gr, target = exonsGR, ranLoc = ranLocGR,
