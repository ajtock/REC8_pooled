...
# Profile mean coverage around gene introns and random loci

# Usage via Condor submission system on node7:
# csmit -m 20G -c 1 "Rscript intron_Profiles_commandArgs.R /home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/log2_REC8_HA_Rep1_ChIP_REC8_MYC_Rep2_input_norm_allchrs_coverage_coord_tab.bed REC8_HA_Rep1"
...
covMatrix(signal = gr, target = intronsGR, ranLoc = ranLocGR,
