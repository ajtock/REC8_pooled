...
hexDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/geneProfiles/geneHexiles/WT_RNAseq_Chris_Rep1/"
...
targetsHex <- paste0(hexDir, "hexile_", c(1:6), "_WT_RNAseq_Chris_Rep1_geneCov.txt")
...
outDFCM <- list(list(paste0(matDir, libName,
                            ...
                            c(1:6),
                            "_by_WT_RNAseq_Chris_Rep1_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
