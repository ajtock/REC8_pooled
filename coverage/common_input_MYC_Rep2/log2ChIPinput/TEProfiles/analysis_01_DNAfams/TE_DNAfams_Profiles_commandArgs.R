...
# csmit -m 50G -c 1 "Rscript TE_DNAfams_Profiles_commandArgs.R /home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/log2_REC8_HA_Rep1_ChIP_REC8_MYC_Rep2_input_norm_allchrs_coverage_coord_tab.bed REC8_HA_Rep1"
...
matDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/TEProfiles/analysis_01_DNAfams/matrices/"
...
for(h in seq_along(DNAfamNames)) {
  ...
  outDFCM <- list(list(paste0(matDir, libName,
                              "_norm_cov_", DNAfamNames[h], "_TEs_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
                       paste0(matDir, libName,
                              "_norm_cov_", DNAfamNames[h], "_ranLoc_mat2_smoothed_target_and_flank_dataframe_colMeans.txt")))
