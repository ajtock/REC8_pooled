...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/TEProfiles/analysis_01_RNAfams/plots/"
...
for(h in seq_along(RNAfamNames)) {
  ...
  pdf(paste0(plotDir, "REC8_HA_Rep1_", RNAfamNames[h], "_TEProfiles_winSize20.pdf"), height = 95, width = 6)
  par(mfrow = c(38, 2))
