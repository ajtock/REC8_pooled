...
pdf(paste0(plotDir, "dna_and_rna_TEProfiles_wt_mutant_REC8_SPO11_1_oligos_CGmeth_CHGmeth_CHHmeth_H3K9me2_RNAseq_SPO11_1_ChIP_MNase_winSize20_manuscript.pdf"), height = 22.5, width = 12)
par(mfrow = c(9, 4))
...
# RNA-seq Rep1
plotAvgCov_WTvMutant_DNA_RNA_TEs(xplot = xplot_DNA,
    DNAdat1 = target_covDat_DNA[[17]][,1],
    DNAmutantDat1  = target_covDat_DNA[[18]][,1],
    DNAranDat1 = ranLoc_covDat_DNA[[17]][,1],
    DNAmutantRanDat1 = ranLoc_covDat_DNA[[18]][,1],
    RNAdat1 = target_covDat_RNA[[17]][,1],
    RNAmutantDat1  = target_covDat_RNA[[18]][,1],
    RNAranDat1 = ranLoc_covDat_RNA[[17]][,1],
    RNAmutantRanDat1 = ranLoc_covDat_RNA[[18]][,1],
    Ylabel1 = YlabelNames[11],
    flankSize = 2000, winSize = 20, 
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "TSS", endLab1 = "TTS",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[17], libNames[18]),
    wtCol =  "blue", mutantCol = "red")
plotAvgCov_WTvMutant_DNA_RNA_TEs(xplot = xplot_RNA,
    DNAdat1 = target_covDat_RNA[[17]][,1],
    DNAmutantDat1  = target_covDat_RNA[[18]][,1],
    DNAranDat1 = ranLoc_covDat_RNA[[17]][,1],
    DNAmutantRanDat1 = ranLoc_covDat_RNA[[18]][,1],
    RNAdat1 = target_covDat_DNA[[17]][,1],
    RNAmutantDat1  = target_covDat_DNA[[18]][,1],
    RNAranDat1 = ranLoc_covDat_DNA[[17]][,1],
    RNAmutantRanDat1 = ranLoc_covDat_DNA[[18]][,1],
    Ylabel1 = YlabelNames[11],
    flankSize = 2000, winSize = 20, 
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "TSS", endLab1 = "TTS",
...
# RNA-seq Rep2
plotAvgCov_WTvMutant_DNA_RNA_TEs(xplot = xplot_DNA,
    DNAdat1 = target_covDat_DNA[[19]][,1],
    DNAmutantDat1  = target_covDat_DNA[[20]][,1],
    DNAranDat1 = ranLoc_covDat_DNA[[19]][,1],
    DNAmutantRanDat1 = ranLoc_covDat_DNA[[20]][,1],
    RNAdat1 = target_covDat_RNA[[19]][,1],
    RNAmutantDat1  = target_covDat_RNA[[20]][,1],
    RNAranDat1 = ranLoc_covDat_RNA[[19]][,1],
    RNAmutantRanDat1 = ranLoc_covDat_RNA[[20]][,1],
    Ylabel1 = YlabelNames[12],
    flankSize = 2000, winSize = 20, 
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "TSS", endLab1 = "TTS",
    startLab2 = "Start", endLab2 = "End",
    legendLoc = "topright",
    legendLabs = c(libNames[19], libNames[20]),
    wtCol =  "blue", mutantCol = "red")
plotAvgCov_WTvMutant_DNA_RNA_TEs(xplot = xplot_RNA,
    DNAdat1 = target_covDat_RNA[[19]][,1],
    DNAmutantDat1  = target_covDat_RNA[[20]][,1],
    DNAranDat1 = ranLoc_covDat_RNA[[19]][,1],
    DNAmutantRanDat1 = ranLoc_covDat_RNA[[20]][,1],
    RNAdat1 = target_covDat_DNA[[19]][,1],
    RNAmutantDat1  = target_covDat_DNA[[20]][,1],
    RNAranDat1 = ranLoc_covDat_DNA[[19]][,1],
    RNAmutantRanDat1 = ranLoc_covDat_DNA[[20]][,1],
    Ylabel1 = YlabelNames[12],
    flankSize = 2000, winSize = 20, 
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "TSS", endLab1 = "TTS",
...
# SPO11-1 ChIP and MNase
plotAvgCov_oneVanother_DNA_RNA_TEs(xplot = xplot_DNA,
    ...
    flankSize = 2000, winSize = 20,
    Ylabel1 = "SPO11-1 ChIP", Ylabel2 = "MNase",
    flankLabL = "-2 kb", flankLabR = "+2 kb",
    startLab1 = "TSS", endLab1 = "TTS",
    startLab2 = "Start", endLab2 = "End",
    dat1Col = "green", dat2Col = "blue")
plotAvgCov_oneVanother_DNA_RNA_TEs(xplot = xplot_RNA,
