...
pdf(paste0(plotDir, "dna_TEProfiles_vs_wt_mutant_REC8_SPO11_1_oligos_RNAseq_H3K9me2_DNAmeth_MNase_PolIV_PolV_winSize20_v310718_talk.pdf"), height = 10, width = 7.5)
par(mfcol = c(4, 3))
par(mar = c(2.1, 3.2, 2.1, 1))
par(mgp = c(2.25, 1, 0))
xplot <- seq(1, length(target_covDat_DNA[[1]][,1]), by = 1)
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat_DNA[[20]][,1],
    mutantDat1  = target_covDat_DNA[[21]][,1],
    ranDat1 = ranLoc_covDat_DNA[[20]][,1],
    mutantRanDat1 = ranLoc_covDat_DNA[[21]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat_DNA[[14]][,1],
    mutantDat1  = target_covDat_DNA[[15]][,1],
    ranDat1 = ranLoc_covDat_DNA[[14]][,1],
    mutantRanDat1 = ranLoc_covDat_DNA[[15]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat_DNA[[23]][,1],
    mutantDat1  = target_covDat_DNA[[24]][,1],
    ranDat1 = ranLoc_covDat_DNA[[23]][,1],
    mutantRanDat1 = ranLoc_covDat_DNA[[24]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat_DNA[[5]][,1],
    mutantDat1  = target_covDat_DNA[[8]][,1],
    ranDat1 = ranLoc_covDat_DNA[[5]][,1],
    mutantRanDat1 = ranLoc_covDat_DNA[[8]][,1],
...
plotAvgCov_WTvMutant(xplot = xplot,
    dat1 = target_covDat_DNA[[10]][,1],
    mutantDat1  = target_covDat_DNA[[12]][,1],
    ranDat1 = ranLoc_covDat_DNA[[10]][,1],
    mutantRanDat1 = ranLoc_covDat_DNA[[12]][,1],
