...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/TEProfiles/TE_wt_vs_kss/analysis_01_RNAfams/plots/"
...
for(h in seq_along(RNAfamNames)) {
  ...
  pdf(paste0(plotDir, RNAfamNames[h], "_TEProfiles_vs_wt_mutant_REC8_SPO11_1_oligos_RNAseq_H3K9me2_DNAmeth_MNase_PolIV_PolV_winSize20.pdf"), height = 40, width = 6)
  par(mfrow = c(16, 2))
