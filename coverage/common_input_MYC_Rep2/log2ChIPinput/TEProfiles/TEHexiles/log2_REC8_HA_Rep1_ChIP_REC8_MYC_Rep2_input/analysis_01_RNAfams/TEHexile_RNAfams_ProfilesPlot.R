...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/TEProfiles/TEHexiles/log2_REC8_HA_Rep1_ChIP_REC8_MYC_Rep2_input/analysis_01_RNAfams/plots/"
...
for(h in seq_along(RNAfamNames)) {
  ...
  pdf(paste0(plotDir, "REC8_HA_Rep1_", RNAfamNames[h], "_TEHexileProfiles_winSize20.pdf"), height = 95, width = 6)
  par(mfrow = c(38, 2))
  ...
  pdf(paste0(plotDir, "REC8_HA_Rep1_", RNAfamNames[h], "_TEHexileProfiles_winSize20_landscape_4pages.pdf"), height = 10, width = 18)
  par(mfrow = c(4, 6))
  par(mar = c(2.1, 3.2, 2.1, 3.2))
  par(mgp = c(2.25, 1, 0))
  xplot <- seq(1, length(targetHexileCovProfiles[[1]][,1]), by = 1)
