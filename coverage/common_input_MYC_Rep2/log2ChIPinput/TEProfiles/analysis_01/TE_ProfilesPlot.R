...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/TEProfiles/analysis_01/plots/"
...
pdf(paste0(plotDir, "REC8_HA_Rep1_TEProfiles_winSize20.pdf"), height = 95, width = 6)
par(mfrow = c(38, 2))
