...
matDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/GBScrossoverProfiles/analysis_01/matrices/"
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/GBScrossoverProfiles/analysis_01/plots/"
...
libNames <- c(
              ...
              "arp6_RNAseq_Kyuha_Rep1",
              "arp6_RNAseq_Kyuha_Rep2",
              "arp6_RNAseq_Kyuha_Rep3",
              ...
              "SPO11_1_oligos_RPI3",
              "SPO11_1_oligos_RPI8",
              "arp6_SPO11_1_oligos_RPI32",
              "arp6_SPO11_1_oligos_RPI33",
              "SPO11_1_ChIP4",
              "SPO11_1_ChIP13",
              "MSH4",
              "PolIV_Rep2",
...
outDFCM <- lapply(seq_along(libNames), function(x)
  list(paste0(matDir, libNames[[x]],
              "_norm_cov_COs_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
...
libNames <- c(
              ...
              "arp6 RNA-seq (buds; Kyuha) Rep1",
              "arp6 RNA-seq (buds; Kyuha) Rep2",
              "arp6 RNA-seq (buds; Kyuha) Rep3",
              ...
              "SPO11-1-oligos RPI3",
              "SPO11-1-oligos RPI8",
              "arp6 SPO11-1-oligos RPI32",
              "arp6 SPO11-1-oligos RPI33",
              "SPO11-1 ChIP4",
              "SPO11-1 ChIP13",
              "MSH4",
              "Pol IV",
...
pdf(paste0(plotDir, "REC8_HA_Rep1_COProfiles_winSize1.pdf"), height = 117.5, width = 6)
par(mfrow = c(47, 2))
...
for(x in 2:length(libNames)) {
  plotAvgCov_oneVanother(xplot = xplot, dat1 = target_covDat[[1]][,1], dat2 = target_covDat[[x]][,1],
                         ...
                         flankSize = 5000, winSize = 1,
                         Ylabel1 = libNames[1], Ylabel2 = libNames[x],
                         flankLabL = "-5 kb", flankLabR = "+5 kb",
...
# Plot mean REC8 vs other coverage profiles around target and random loci
pdf(paste0(plotDir, "REC8_HA_Rep1_COProfiles_winSize1_landscape.pdf"), height = 25, width = 30)
par(mfrow = c(10, 10))
par(mar = c(2.1, 3.2, 2.1, 3.2))
par(mgp = c(2.25, 1, 0))
xplot <- seq(1, length(target_covDat[[1]][,1]), by = 1)
