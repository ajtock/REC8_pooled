...
matDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/DMRprofiles/kss_hypoCHH/analysis_01/matrices/"
...
DMRs <- read.table("/home/meiosis/ajt200/BS_Seq/Stroud_2013/DMRs/suvh456_hypoCHH_DMR_vs3reps_min4filter_mg200.bed", header = F)
...
outDFCM <- list(list(paste0(matDir, libName,
                            "_norm_cov_kss_hypoCHH_DMRs_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
                     paste0(matDir, libName,
                            "_norm_cov_kss_hypoCHH_ranLoc_mat2_smoothed_target_and_flank_dataframe_colMeans.txt")))
