...
plotDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/DMRprofiles/kss_hypoCHH/analysis_01/plots/"
...
pdf(paste0(plotDir, "kss_hypoCHH_DMR_Profiles_wt_mutant_REC8_SPO11_1_oligos_RNAseq_H3K9me2_DNAmeth_MNase_PolIV_PolV_winSize20.pdf"), height = 40, width = 6)
par(mfrow = c(16, 2))
