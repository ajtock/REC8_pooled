...
pdf(paste0(plotDir, "kss_hypoCHG_DMR_Profiles_wt_mutant_REC8_SPO11_1_oligos_RNAseq_H3K9me2_DNAmeth_MNase_PolIV_PolV_winSize20_v310718_talk.pdf"), height = 10, width = 7.5)
par(mfcol = c(4, 3))
