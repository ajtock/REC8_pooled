...
# csmit -m 20G -c 1 "Rscript DMR_Profiles_commandArgs.R /home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/log2_REC8_HA_Rep1_ChIP_REC8_MYC_Rep2_input_norm_allchrs_coverage_coord_tab.bed REC8_HA_Rep1"
...
matDir <- "/home/meiosis/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep2/log2ChIPinput/DMRprofiles/cmt3_hypoCHH/analysis_01/matrices/"
...
DMRs <- read.table("/home/meiosis/ajt200/BS_Seq/Stroud_2013/DMRs/cmt3_hypoCHH_DMR_vs3reps_min4filter_mg200.bed", header = F)
...
outDFCM <- list(list(paste0(matDir, libName,
                            "_norm_cov_cmt3_hypoCHH_DMRs_mat1_smoothed_target_and_flank_dataframe_colMeans.txt"),
                     paste0(matDir, libName,
                            "_norm_cov_cmt3_hypoCHH_ranLoc_mat2_smoothed_target_and_flank_dataframe_colMeans.txt")))
