...
outDir4 <- "/home/meiosis/ajt200/analysis/180622_Chris_lambing_ChIP_REC8_HA_Col_kss/kss/coverage/log2ChIPinput/genomeProfiles/"
...
outDir9 <- "/home/meiosis/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/WT/coverage/genomeProfiles/"
...
outDir11 <- "/home/meiosis/ajt200/analysis/170918_Chris_RNAseq_Col_kss/fastq_pooled/kss/coverage/genomeProfiles/"
ChIPnames11 <- "kss_RNAseq_Chris_Rep2"
names11 <- "kss RNA-seq (Chris) Rep2"

outDirCombined <- c(outDir1, outDir2, outDir3, outDir4, outDir5, outDir6, outDir7, outDir8, outDir9, outDir10, outDir11)
ChIPnamesCombined <- c(ChIPnames1, ChIPnames2, ChIPnames3, ChIPnames4, ChIPnames5, ChIPnames6, ChIPnames7, ChIPnames8, ChIPnames9, ChIPnames10, ChIPnames11)
namesCombined <- c(names1, names2, names3, names4, names5, names6, names7, names8, names9, names10, names11)
...
## REC8-HA Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep1_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))

for(i in 5:length(filt_log2trans_list)) {
...
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[5]][,1],
                          filt_norm = filt_log2trans_list[[5]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[5]][,1],
                          filt_other_norm = filt_log2trans_list[[7]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[7]][,1],
                          Ylabel = namesCombined[5],
                          otherYlabel = namesCombined[7])
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[6]][,1],
                          filt_norm = filt_log2trans_list[[6]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[6]][,1],
                          filt_other_norm = filt_log2trans_list[[7]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[7]][,1],
                          Ylabel = namesCombined[6],
                          otherYlabel = namesCombined[7])
...
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[9]][,1],
                          filt_norm = filt_log2trans_list[[9]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[9]][,1],
                          filt_other_norm = filt_log2trans_list[[11]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[11]][,1],
                          Ylabel = namesCombined[9],
                          otherYlabel = namesCombined[11])
dev.off()

##################
## REC8-HA Rep2 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep2_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[2]][,1],
                          filt_norm = filt_log2trans_list[[2]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[2]][,1],
                          filt_other_norm = filt_log2trans_list[[4]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[4]][,1],
                          Ylabel = namesCombined[2],
                          otherYlabel = namesCombined[4])
...
## REC8-MYC Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_MYC_Rep1_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[3]][,1],
                          filt_norm = filt_log2trans_list[[3]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[3]][,1],
                          filt_other_norm = filt_log2trans_list[[4]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[4]][,1],
                          Ylabel = namesCombined[3],
                          otherYlabel = namesCombined[4])
