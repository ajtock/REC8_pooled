...
names24 <- "kss RNA-seq (Chris) Rep1"
...
names25 <- "kss RNA-seq (Chris) Rep2"
...
## REC8 all reps ##
###################
pdf(file = paste0(plotDir, "REC8_all_reps_common_input_MYC_Rep2_log2_zscore_genomeplot_",
                  winNames[1], "_h3w9_rho.pdf"), height = 3, width = 9)
par(mfcol = c(1, 1))
...
## REC8-HA Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep1_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
...
## REC8-MYC Rep2 ##
###################
pdf(file = paste0(plotDir, "REC8_MYC_Rep2_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
## REC8-MYC Rep1 ##
###################
pdf(file = paste0(plotDir, "REC8_MYC_Rep1_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
colnames(allDF) <- c("REC8_HA_Rep1", "REC8_MYC_Rep2", "REC8_MYC_Rep1")
allDF_corMat <- cor(allDF, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(plotDir, "REC8_HA_MYC_filtered_genome-wide_correlation_matrix_", winNames[1], "_colouronly.pdf"))
