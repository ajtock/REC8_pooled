...
pdf(file = paste0(plotDir, "REC8_HA_Rep1_Rep2_MYC_Rep1_log2_zscore_genomeplot_",
                  winNames[1], "_h3w9_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 3, width = 9)
par(mfcol = c(1, 1))
...
## REC8-HA Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep1_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
...
## REC8-HA Rep2 ##
###################
pdf(file = paste0(plotDir, "REC8_HA_Rep2_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
## REC8-MYC Rep1 ##
###################
pdf(file = paste0(plotDir, "REC8_MYC_Rep1_vs_others_log2_zscore_genomeplot_", winNames[1], "_h35w15_rho_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"), height = 35, width = 15)
par(mfcol = c(14, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
pdf(file = paste0(plotDir, "REC8_HA_Rep1_Rep2_MYC_Rep1_filtered_genome-wide_correlation_matrix_", winNames[1], "_colouronly_MYC_Rep2_input_kss_HA_Rep1_input_v020718.pdf"))
