...
## REC8-HA Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep1_H3K9me2_RNAseq_SPO11oligos_DNAmeth_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v260718.pdf"), height = 25, width = 15)
par(mfcol = c(10, 2))
...
genoVsOtherGenoGenomePlot(xplot = filt_log2trans_list[[12]][,1],
                          filt_norm = filt_log2trans_list[[12]][,2],
                          filt_norm_noNA = filt_noNA_log2trans_list[[12]][,1],
                          filt_other_norm = filt_log2trans_list[[14]][,2],
                          filt_other_norm_noNA = filt_noNA_log2trans_list[[14]][,1],
                          Ylabel = namesCombined[14],
                          otherYlabel = namesCombined[14])
genoVsOtherGenoGenomePlot(xplot = filt_wtMethDat[,1],
                          filt_norm = filt_wtMethDat[,5],
                          filt_norm_noNA = filt_noNA_wtMethDat[,5],
                          filt_other_norm = filt_kssMethDat[,5],
                          filt_other_norm_noNA = filt_noNA_kssMethDat[,5],
                          Ylabel = "wt DNA methylation",
                          otherYlabel = "kss DNA methylation")
dev.off()

##################
## REC8-HA Rep2 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep2_H3K9me2_RNAseq_SPO11oligos_DNAmeth_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v260718.pdf"), height = 25, width = 15)
par(mfcol = c(10, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
## REC8-MYC Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_MYC_Rep1_H3K9me2_RNAseq_SPO11oligos_DNAmeth_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v260718.pdf"), height = 25, width = 15)
par(mfcol = c(10, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
