...
# csmit -m 20G -c 1 "./log2_ChIPinput_per10kb_commandArgs_v020518.R REC8_HA_Rep1_ChIP REC8_MYC_Rep2_input 10000 10kb"
...
outDir <- "../../log2ChIPinput/genomeProfiles/" 
...
for(i in 1:5) {
  ...
  windowsIRanges <- IRanges(start = seqWindows, width = winSize)
