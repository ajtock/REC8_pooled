...
# Recombination
outDir11 <- "/projects/ajt200/BAM_masters/SPO11-oligo/WT/coverage/log2ChIPinput/genomeProfiles/"
ChIPnames11 <- "WT_SPO11_oligo_RPI1"
names11 <- "SPO11-1-oligos"

outDir12 <- "/projects/ajt200/BAM_masters/SPO11_ChIP/WT/coverage/REC8_MYC_Rep2_input/log2ChIPinput/genomeProfiles/"
ChIPnames12 <- "WT_SPO11_ChIP4"
names12 <- "SPO11-1 ChIP"
...
# Load concatenated filtered crossover dataset
...
## Recombination:
SPO11_1_oligos <- filt_log2trans_list[[11]]
SPO11_1_ChIP <- filt_log2trans_list[[12]]
Crossovers <- filt_CODat
## Euchromatin:
Genes <- filt_GeneDat
...
allDF <- data.frame(REC8_HA[,2], SPO11_1_oligos[,2], SPO11_1_ChIP[,2], Crossovers[,2],
                    Genes[,2], H3K4me1[,2], H3K4me2[,2], H3K4me3[,2], H2AZ[,2], H3K27me3[,2],
                    Transposons[,2], DNAmeth[,2], DNAmeth[,3], DNAmeth[,4], H2AW[,2], H3K9me2[,2], H3K27me1[,2], Nucleosomes[,2])
colnames(allDF) <- c("REC8-HA", "SPO11-1-oligos", "SPO11-1 ChIP", "Crossovers",
...
pdf(file = paste0(plotDir, "REC8_HA_Rep1_filtered_genome-wide_correlation_matrix_", winNames[1], "_colouronly_v050618.pdf"),
                  height = 8, width = 8)
...
SPO11_1_ChIP_armL <- NULL
SPO11_1_ChIP_armR <- NULL
SPO11_1_ChIP_arm <- NULL
SPO11_1_ChIP_peri <- NULL
...
for(i in 1:5) {
  ...
  print(i)
  SPO11_1_oligos_armL_tmp <- SPO11_1_oligos[SPO11_1_oligos[,1] > sumchr[i] & SPO11_1_oligos[,1] < pericenStart[i] & SPO11_1_oligos[,1] < sumchr[i+1],]
  SPO11_1_oligos_armR_tmp <- SPO11_1_oligos[SPO11_1_oligos[,1] > pericenEnd[i] & SPO11_1_oligos[,1] <= sumchr[i+1],]
  SPO11_1_oligos_arm_tmp <- SPO11_1_oligos[(SPO11_1_oligos[,1] > sumchr[i] & SPO11_1_oligos[,1] < pericenStart[i] & SPO11_1_oligos[,1] < sumchr[i+1]) |
                                           (SPO11_1_oligos[,1] > pericenEnd[i] & SPO11_1_oligos[,1] <= sumchr[i+1]),]
  SPO11_1_oligos_peri_tmp <- SPO11_1_oligos[SPO11_1_oligos[,1] >= pericenStart[i] & SPO11_1_oligos[,1] <= pericenEnd[i],]
  ...
  print(i)
  SPO11_1_ChIP_armL_tmp <- SPO11_1_ChIP[SPO11_1_ChIP[,1] > sumchr[i] & SPO11_1_ChIP[,1] < pericenStart[i] & SPO11_1_ChIP[,1] < sumchr[i+1],]
  SPO11_1_ChIP_armR_tmp <- SPO11_1_ChIP[SPO11_1_ChIP[,1] > pericenEnd[i] & SPO11_1_ChIP[,1] <= sumchr[i+1],]
  SPO11_1_ChIP_arm_tmp <- SPO11_1_ChIP[(SPO11_1_ChIP[,1] > sumchr[i] & SPO11_1_ChIP[,1] < pericenStart[i] & SPO11_1_ChIP[,1] < sumchr[i+1]) |
                                       (SPO11_1_ChIP[,1] > pericenEnd[i] & SPO11_1_ChIP[,1] <= sumchr[i+1]),]
  SPO11_1_ChIP_peri_tmp <- SPO11_1_ChIP[SPO11_1_ChIP[,1] >= pericenStart[i] & SPO11_1_ChIP[,1] <= pericenEnd[i],]
  SPO11_1_ChIP_peri <- rbind(SPO11_1_ChIP_peri, SPO11_1_ChIP_peri_tmp)
  SPO11_1_ChIP_armL <- rbind(SPO11_1_ChIP_armL, SPO11_1_ChIP_armL_tmp)
  SPO11_1_ChIP_armR <- rbind(SPO11_1_ChIP_armR, SPO11_1_ChIP_armR_tmp)
  SPO11_1_ChIP_arm <- rbind(SPO11_1_ChIP_arm, SPO11_1_ChIP_arm_tmp)
  ...
  print(i)
  Crossovers_armL_tmp <- Crossovers[Crossovers[,1] > sumchr[i] & Crossovers[,1] < pericenStart[i] & Crossovers[,1] < sumchr[i+1],]
  Crossovers_armR_tmp <- Crossovers[Crossovers[,1] > pericenEnd[i] & Crossovers[,1] <= sumchr[i+1],]
  Crossovers_arm_tmp <- Crossovers[(Crossovers[,1] > sumchr[i] & Crossovers[,1] < pericenStart[i] & Crossovers[,1] < sumchr[i+1]) |
                                           (Crossovers[,1] > pericenEnd[i] & Crossovers[,1] <= sumchr[i+1]),]
  Crossovers_peri_tmp <- Crossovers[Crossovers[,1] >= pericenStart[i] & Crossovers[,1] <= pericenEnd[i],]
...
allDF_arm <- data.frame(REC8_HA_arm[,2], SPO11_1_oligos_arm[,2],  SPO11_1_ChIP_arm[,2], Crossovers_arm[,2],
                        Genes_arm[,2], H3K4me1_arm[,2], H3K4me2_arm[,2], H3K4me3_arm[,2], H2AZ_arm[,2], H3K27me3_arm[,2],
                        Transposons_arm[,2], DNAmeth_arm[,2], DNAmeth_arm[,3], DNAmeth_arm[,4], H2AW_arm[,2], H3K9me2_arm[,2], H3K27me1_arm[,2], Nucleosomes_arm[,2])
colnames(allDF_arm) <- c("REC8-HA", "SPO11-1-oligos", "SPO11-1 ChIP", "Crossovers",
                         "Genes", "H3K4me1", "H3K4me2", "H3K4me3", "H2A.Z", "H3K27me3",
                         "Transposons", "CG", "CHG", "CHH", "H2A.W", "H3K9me2", "H3K27me1", "Nucleosomes")
allDF_arm_corMat <- cor(allDF_arm, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("blue", "white", "red"))
pdf(file = paste0(plotDir, "REC8_HA_Rep1_filtered_arms_correlation_matrix_", winNames[1], "_colouronly_v050618.pdf"),
                  height = 8, width = 8)
...
allDF_peri <- data.frame(REC8_HA_peri[,2], SPO11_1_oligos_peri[,2],  SPO11_1_ChIP_peri[,2], Crossovers_peri[,2],
                         Genes_peri[,2], H3K4me1_peri[,2], H3K4me2_peri[,2], H3K4me3_peri[,2], H2AZ_peri[,2], H3K27me3_peri[,2],
...
colnames(allDF_peri) <- c("REC8-HA", "SPO11-1-oligos", "SPO11-1 ChIP", "Crossovers",
                          "Genes", "H3K4me1", "H3K4me2", "H3K4me3", "H2A.Z", "H3K27me3",
                          "Transposons", "CG", "CHG", "CHH", "H2A.W", "H3K9me2", "H3K27me1", "Nucleosomes")
allDF_peri_corMat <- cor(allDF_peri, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("blue", "white", "red"))
pdf(file = paste0(plotDir, "REC8_HA_Rep1_filtered_pericentromeres_correlation_matrix_", winNames[1], "_colouronly_v050618.pdf"),
                  height = 8, width = 8)
