...
## REC8-HA Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep1_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v290618.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
...
## REC8-HA Rep2 ##
##################
pdf(file = paste0(plotDir, "REC8_HA_Rep2_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v290618.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
## REC8-MYC Rep1 ##
##################
pdf(file = paste0(plotDir, "REC8_MYC_Rep1_H3K9me2_RNAseq_wt_vs_kss_and_cmt3_log2_zscore_genomeplot_", winNames[1], "_rho_MYC_Rep2_input_v290618.pdf"), height = 17.5, width = 15)
par(mfcol = c(7, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
