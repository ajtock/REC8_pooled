...
# Usage:
# ./log2_ChIPinput_perwin_arm_peri_rho_corr_matrices_v190619.R 10kb
...
pdf(file = paste0(plotDir, "REC8_HA_Rep2_filtered_genomewide_correlation_matrix_", winName, "_colouronly_genomewideZscore_v190619.pdf"),
                  height = 12, width = 11)
...
col1 <- colorRampPalette(c("blue", "white", "red"))
pdf(file = paste0(plotDir, "REC8_HA_Rep2_filtered_arms_correlation_matrix_", winName, "_colouronly_genomewideZscore_v190619.pdf"),
                  height = 12, width = 11)
...
col1 <- colorRampPalette(c("blue", "white", "red"))
pdf(file = paste0(plotDir, "REC8_HA_Rep2_filtered_pericentromeres_correlation_matrix_", winName, "_colouronly_genomewideZscore_v190619.pdf"),
                  height = 12, width = 11)
...
pdf(file = paste0(plotDir, "REC8_HA_Rep2_filtered_genomewide_arms_pericentromeres_correlation_matrix_", winName, "_colouronly_genomewideZscore_v190619.pdf"),
                  height = 25.5, width = 8)
par(mfcol = c(3, 1))
corrplot(allDF_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "grey90", mar = c(0,0,1,0), tl.cex = 1.5, cl.cex = 1.5, number.cex = 1.0,
