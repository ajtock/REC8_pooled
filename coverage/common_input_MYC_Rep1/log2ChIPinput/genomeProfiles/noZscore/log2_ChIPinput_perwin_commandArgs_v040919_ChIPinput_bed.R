...
# csmit -m 20G -c 1 "Rscript ./log2_ChIPinput_perwin_commandArgs_v040919_ChIPinput_bed.R '/home/ajt200/analysis/170920_Chris_ChIP_REC8_histone/fastq_pooled/H3K4me1/coverage/' '/projects/ajt200/BAM_masters/H3K9me2/WT/coverage/' WT_H3K4me1_Rep1_ChIP WT_H3K9me2_input 10000 10kb 101"

library(segmentSeq)
library(GenomicRanges)
library(parallel)

#ChIPDir <- "/home/ajt200/analysis/170920_Chris_ChIP_REC8_histone/fastq_pooled/H3K4me1/coverage/"
#inputDir <- "/projects/ajt200/BAM_masters/H3K9me2/WT/coverage/"
#ChIPname <- "WT_H3K4me1_Rep1_ChIP"
#inputname <- "WT_H3K9me2_input"
#winSize <- 10000
#winName <- "10kb"
#smoothN <- 101
...
ChIPfile <- paste0(ChIPDir, ChIPname, "_input_norm_allchrs_coverage_coord_tab.bed")
inputfile <- paste0(inputDir, inputname, "_norm_allchrs_coverage_coord_tab.bed")

ChIP <- read.table(ChIPfile,
                   colClasses = c(NA, rep("NULL", 2), NA, "NULL"))
