...
# Usage:
# ./log2_ChIPinput_perwin_PLOTONLY_ASY1_v_others_v031019.R 10kb
...
# Plot
pdf(paste0(plotDir, "ASY1_Rep2_vs_others_genomeProfiles_noZscore_v031019.pdf"),
    height = 132, width = 12)
par(mfcol = c(33, 1))
...
dat1to2diffY(xplot = lib_filt_winDF_list[[2]]$cumwindow,
             ...
             dat1Colour = libColours[8],
             dat2Colour = libColours[2])
# DMC1 Rep1 vs SPO11-1-oligos
dat1to2diffY(xplot = lib_filt_winDF_list[[6]]$cumwindow,
             dat1 = lib_filt_winDF_list[[9]]$filt_log2,
             dat2 = lib_filt_winDF_list[[6]]$filt_log2,
             dat1Lab = libNamesPlot[9],
             dat2Lab = libNamesPlot[6],
             dat1Colour = libColours[9],
             dat2Colour = libColours[6])
# DMC1 Rep1 vs ASY1
dat1to2diffY(xplot = lib_filt_winDF_list[[1]]$cumwindow,
             dat1 = lib_filt_winDF_list[[9]]$filt_log2,
