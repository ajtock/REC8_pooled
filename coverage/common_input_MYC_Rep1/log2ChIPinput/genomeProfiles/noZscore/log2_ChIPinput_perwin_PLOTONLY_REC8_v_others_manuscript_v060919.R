...
# Usage:
# Rscript ./log2_ChIPinput_perwin_PLOTONLY_REC8_v_others_manuscript_v060919.R 10kb
...
libNames <- c(
              ...
              "ASY1_Rep1_ChIP_REC8_MYC_Rep1_input",
...
# Plot
pdf(paste0(plotDir, "REC8_vs_others_genomeProfiles_noZscore_v060919.pdf"),
    height = 76, width = 12)
par(mfcol = c(19, 1))
...
dat1to2diffY(xplot = lib_filt_winDF_list[[1]]$cumwindow,
             ...
             dat1Colour = libColours[1],
             dat2Colour = "darkblue")
# MTOPVIB, SPO11-1 ChIP, ASY1, and the rest
for(x in 6:length(libNames)) {
  dat1to2diffY(xplot = lib_filt_winDF_list[[1]]$cumwindow,
               dat1 = lib_filt_winDF_list[[1]]$filt_log2,
