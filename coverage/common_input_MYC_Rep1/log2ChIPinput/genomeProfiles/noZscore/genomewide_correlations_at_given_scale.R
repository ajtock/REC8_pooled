...
kss_REC8_HA_Rep1_list <- lapply(seq_along(winNames), function(x) {
  read.table(paste0("kss_REC8_HA_Rep1_ChIP_kss_REC8_HA_Rep1_input_genome_norm_coverage_",
                    winNames[x], "_noZscore.tsv"),
             header = T)[,6]
})
...
REC8_HA_Rep1_v_kss_REC8_HA_Rep1 <- sapply(seq_along(winNames), function(x) {
  cor(x = REC8_HA_Rep1_list[[x]],
      y = kss_REC8_HA_Rep1_list[[x]],
      method = "spearman")
})
# REC8_HA_Rep2
...
REC8_HA_Rep2_v_kss_REC8_HA_Rep1 <- sapply(seq_along(winNames), function(x) {
  cor(x = REC8_HA_Rep2_list[[x]],
      y = kss_REC8_HA_Rep1_list[[x]],
      method = "spearman")
})
# REC8_MYC_Rep1
REC8_MYC_Rep1_v_kss_REC8_HA_Rep1 <- sapply(seq_along(winNames), function(x) {
  cor(x = REC8_MYC_Rep1_list[[x]],
      y = kss_REC8_HA_Rep1_list[[x]],
      method = "spearman")
})
...
corrDF <- data.frame(
                     REC8_HA_Rep1_v_REC8_HA_Rep2 = round(REC8_HA_Rep1_v_REC8_HA_Rep2, digits = 2),
                     REC8_HA_Rep1_v_REC8_MYC_Rep1 = round(REC8_HA_Rep1_v_REC8_MYC_Rep1, digits = 2),
                     REC8_HA_Rep1_v_kss_REC8_HA_Rep1 = round(REC8_HA_Rep1_v_kss_REC8_HA_Rep1, digits = 2),
                     REC8_HA_Rep2_v_REC8_MYC_Rep1 = round(REC8_HA_Rep2_v_REC8_MYC_Rep1, digits = 2),
                     REC8_HA_Rep2_v_kss_REC8_HA_Rep1 = round(REC8_HA_Rep2_v_kss_REC8_HA_Rep1, digits = 2),
                     REC8_MYC_Rep1_v_kss_REC8_HA_Rep1 = round(REC8_MYC_Rep1_v_kss_REC8_HA_Rep1, digits = 2)
                    )
write.table(corrDF,
            file = "REC8_library_spearman_correlations_at_varying_scales.tsv",
