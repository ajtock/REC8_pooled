...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_DNAmeth_noCorr.R DNA_TEs 'DNA TEs' 2000 2kb '2 kb' 20 20bp 'mCG,mCHG,mCHH' 'mCG,mCHG,mCHH' 'darkorange3,orange,yellow3' '0.02,0.70'
