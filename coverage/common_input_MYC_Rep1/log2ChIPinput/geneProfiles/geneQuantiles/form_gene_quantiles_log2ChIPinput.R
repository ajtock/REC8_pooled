...
# Usage:
# ./form_gene_quantiles_log2ChIPinput.R '/home/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep1/log2ChIPinput/noZscore/' 'log2_REC8_HA_Rep2_ChIP_REC8_MYC_Rep1_input' 'bodies' 6 
