...
# Example usage:
# topGO_REC8_TAIR10_GO_GOSLIM_230418.R BP hexile_1_log2_REC8_HA_Rep1_ChIP_REC8_MYC_Rep2_input_geneCov.txt 0.05
...
genesetGO <- function(target) {
  ...
  genesOfInterest <- substr(as.character(read.table(target)$gene_model), 1, 9)
  ...
  capture.output(GOdata <- new("topGOdata", description = "REC8 hexile genes", ontology = ont,
