...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr_RNAseq.R Genes 'Genes' 2000 2kb '2 kb' 20 20bp 'WT_RNAseq_Chris_Rep1' 'Expression' 'magenta' '0.69,0.25'
