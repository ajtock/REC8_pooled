...
matDir <- "/home/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep1/log2ChIPinput/geneProfiles/heatmaps_analysis_01/matrices/"
plotDir <- "/home/ajt200/analysis/REC8_pooled/coverage/common_input_MYC_Rep1/log2ChIPinput/geneProfiles/heatmaps_analysis_01/plots/"
...
outDFCM <- lapply(seq_along(libNames), function(x)
  list(paste0(matDir, libNames[[x]],
              "_norm_cov_feature_smoothed_target_and_2kb_flank_dataframe_colMeans.txt"),
       paste0(matDir, libNames[[x]],
              "_norm_cov_ranLoc_smoothed_target_and_2kb_flank_dataframe_colMeans.txt")))
...
pdf(paste0(plotDir, "REC8_HA_Rep2_geneProfileCorrMatrices_winSize20_TSS_TTS.pdf"),
    height = 24, width = 12)
par(mfrow = c(2, 1))
