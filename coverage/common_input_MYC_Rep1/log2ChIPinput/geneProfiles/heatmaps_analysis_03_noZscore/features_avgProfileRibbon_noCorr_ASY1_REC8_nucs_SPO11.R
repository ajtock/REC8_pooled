...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr_ASY1_REC8_nucs_SPO11.R Genes 'Genes' 2000 2kb '2 kb' 20 20bp 'ASY1_Rep2,REC8_HA_Rep2,MNase,SPO11_1_oligos_RPI1' 'ASY1,REC8-HA,Nucleosomes,SPO11-1' 'red,green2,purple4,dodgerblue2' '0.69,0.30'
...
#binSize <- 20
#binName <- "20bp"
#libNames <- unlist(strsplit("ASY1_Rep2,REC8_HA_Rep2,SPO11_1_oligos_RPI1,MNase,H3K9me2",
#                            split = ","))
#libNamesPlot <- unlist(strsplit("ASY1,REC8-HA,SPO11-1,Nucleosomes,H3K9me2",
#                                split = ","))
#colours <- unlist(strsplit("red,green2,dodgerblue2,aquamarine,green2",
#                           split = ","))
