...
# Usage:
# /applications/R/R-3.5.0/bin/Rscript features_avgProfileRibbon_noCorr.R HypoCHG_DMRs_kss 'HypoCHG DMRs' 2000 2kb '2 kb' 20 20bp 'REC8_HA_Rep2,kss_REC8_HA_Rep1' 'wt REC8-HA,kss REC8-HA' 'red,red4' '0.02,0.94'
...
#binSize <- 20
#binName <- "20bp"
#libNames <- unlist(strsplit("REC8_HA_Rep2,kss_REC8_HA_Rep1",
#                            split = ","))
#libNamesPlot <- unlist(strsplit("wt REC8-HA,kss REC8-HA",
#                                split = ","))
